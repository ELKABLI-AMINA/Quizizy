  ...
  if (count < arrObj.length) {
    ...
    try {
      for (var _iterator = incorrect[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        document.getElementById("answers").innerHTML += " <ul class=\"ul\"><li class=\"questionli\"> <strong>Questionfuck ".concat(_i2, ":</strong> ").concat(arrObj[_i2].question, " </li> <li class=\"reponseli\">  <strong>Reponse</strong> :").concat(arrObj[_i2].answer[arrObj[_i2].correct], " </li> <li class=\"explicationli\" > <strong>Explication:</strong> ").concat(arrObj[_i2].Explication, " </li> </ul>");
      }
    } catch (err) {
